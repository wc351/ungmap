...
urlpatterns = patterns('',
    ...
    url(r'^recreation/$', views.RecreationView.as_view(), name='recreation_view'),
    url(r'^faculty/$', views.FacultyView.as_view(), name='faculty_view'),
    url(r'^parkinglots/$', views.ParkingLotsView.as_view(), name='parking_lots_view'),
